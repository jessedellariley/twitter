...
I had some trouble in get requests to the Twitter API - at first, my API keys were not working, and I was getting a 403 error. Additionally, I misnamed one of the keys in the JSON, which took a few minutes to realize. I also had some difficulty adding the swipe refresh layout aroun the recycler view, which also turned out to be a typo.
